...
import 'package:video_call/utils/settings.dart';

class CallScreen extends StatefulWidget {
  static const ROUTE_NAME = 'call';
...
class _CallScreenState extends State<CallScreen> {
  ...
  Future<void> initialize() async {
    ...
    await AgoraRtcEngine.joinChannel(APP_ID, widget.channelName, null, 0);
  }
  ...
  void _addAgoraEventHandlers() {
    ...
    AgoraRtcEngine.onUserOffline = (uid, elapsed) {
      if (mounted) {
        setState(() {
    ...
    AgoraRtcEngine.onFirstRemoteVideoFrame = (uid, width, height, elapsed) {
      if (mounted) {
        setState(() {
    ...
    return Scaffold(
      ...
      body: Center(
        child: Stack(
          children: <Widget>[
            _viewRows(),
            if(widget.fromCreateScreen)_shareIcon(),
            _panel(),
            _toolbar(),
          ],
        ),
