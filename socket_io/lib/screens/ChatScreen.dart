...
import 'package:socket_io/models/ChatMessage.dart';
import 'package:socket_io/models/SocketService.dart';
import 'package:socket_io/models/User.dart';
import 'package:socket_io/widgets/ChatBubble.dart';
import 'package:socket_io/widgets/ChatTitle.dart';
...
//    SocketService.socket.send();
  ...
  _initSocketListeners() async {
    SocketService.socket.on('receive_message', onChatMessageReceived);
...
//    G.socketUtils.checkOnline(chatMessageModel);
  ...
  _sendButtonTap() async {
    ...
    _clearMessage();
    SocketService.socket.emit('single_chat_message',[chatMessageModel.toJson()]);
  }
